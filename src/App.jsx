    ...
    export default function TravelPlanner() {
      ...
      [
        {
          "day": ${chunkStart},
          "theme": "theme title",
          "morning": { "activity": "name", "description": "2 full sentences 30-50 words. Describe what it is and why it's worth visiting.", "tip": "max 15 words", "duration": "X hours" },
          "afternoon": { "activity": "name", "description": "2 full sentences 30-50 words. Describe what it is and why it's worth visiting.", "tip": "max 15 words", "duration": "X hours" },
          "evening": { "activity": "name", "description": "2 full sentences 30-50 words. Describe what it is and why it's worth visiting.", "tip": "max 15 words", "duration": "X hours" },
      ...
      Generate days ${chunkStart} to ${chunkEnd} only. Raw JSON array, nothing else.`;
            ...
            if (data.error) throw new Error(`Groq error (chunk ${i + 1}): ${JSON.stringify(data.error)}`);
              ...
              return (
                <div style={{ marginBottom: 24 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    {/* Prev week arrow */}
                    <button
                      onClick={() => setActiveDay((currentWeek - 1) * WEEK)}
                      ...
                      style={{
                        ...
                        fontSize: "0.9rem", flexShrink: 0, transition: "all .15s",
                      }}
                    >‹</button>
